...
export const BOOK_CATALOG: BookEntry[] = [
  ...
  },
  {
    ...
    tagline:        'Every hero has to start somewhere',
    description:    'On the first day at the most exciting school in the world, one student discovers a power nobody else has — and learns that being a true hero is about far more than flying.',
    themes:         ['Superpowers', 'Courage', 'Teamwork'],
    ageRange:       '4–9',
    pageCount:      24,
    priceFormatted: '$24.99',
    priceCents:     2499,
  ...
  },
  {
    ...
    tagline:        'X marks the spot — but first you have to find X',
    description:    'A mysterious map, a talking parrot, and a sea full of adventures await the bravest young captain to ever set sail on the Sparkling Sea.',
    themes:         ['Pirates', 'Adventure', 'Maps'],
    ageRange:       '4–9',
    pageCount:      24,
    priceFormatted: '$24.99',
    priceCents:     2499,
  ...
  },
  {
    ...
    tagline:        'Every spell begins with believing in yourself',
    description:    'Through the ancient doors of Wyndmere Academy, one new student discovers a gift for magic that surprises everyone — including themselves.',
    themes:         ['Magic', 'School', 'Friendship'],
    ageRange:       '5–10',
    pageCount:      24,
    priceFormatted: '$24.99',
    priceCents:     2499,
  ...
  {
    id:             'safari-quest',
    title:          'The Safari Quest',
    tagline:        'The greatest adventure is just beyond the next hill',
    description:    'Deep in the golden savannah, the animals are in trouble — and a young explorer with a big heart is the only one who can bring peace back to the wild.',
    themes:         ['Animals', 'Nature', 'Kindness'],
    ageRange:       '3–8',
    pageCount:      24,
    priceFormatted: '$24.99',
    priceCents:     2499,
  ...
  {
    id:             'mermaid-kingdom',
    title:          'The Mermaid Kingdom',
    tagline:        'The ocean has been waiting for you',
    description:    'When a glowing shell washes ashore, it carries a message from the Mermaid Kingdom — they need the bravest child on land to help save their world.',
    themes:         ['Ocean', 'Magic', 'Bravery'],
    ageRange:       '3–8',
    pageCount:      24,
    priceFormatted: '$24.99',
    priceCents:     2499,
